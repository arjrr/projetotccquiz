...
public class PerguntasDAOImp implements PerguntasDAO {
    ...
    public void insertPergunta(Perguntas p) {
        try {
            PreparedStatement preparedStatement = mySQLAccess.getConnection().prepareStatement("INSERT INTO mydb.perguntas (descricao, respA, respB, respC, respD, respcorreta) VALUES (?, ?, ?, ?, ?, ?)");
